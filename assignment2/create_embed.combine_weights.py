...
def main():
	...
	embed_size = 300
	src_embed_file = "./align_embed/data.fast/wiki.%s+%s-en.vec" % (l1, l2)
	tgt_embed_file = "./align_embed/data.fast/wiki.en-en.vec"

	weights_file = "./align_embed/data.weights/wiki.%s+%s-en.weights" % (l1, l2)
	vocab_file = "./data/vocab.%s+%s-en.bin" % (l1, l2)
	src_embed = {}
	tgt_embed = {}
